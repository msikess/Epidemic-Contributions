...
/* The following script was used to animate tubes to show
	the progression of the cure (works like a health bar).
	The script sets/resets the fill of an image and its mask
...
public class TubeScript : MonoBehaviour {
	...
	//since the code is attached to the whole object, the img here is the filler part;
	[SerializeField]
	private Image img;
	[SerializeField]
	private Image img2;
